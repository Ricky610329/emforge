...
3. **目前的任務書：`docs/plan-2026-09-07-round3.md`**（第三輪 M17–M20：評估層、歷程與取樣、收件匣＋client、平台 MCP）。裡面有環境、測試指令、契約速查、每個里程碑的檔案與驗收。照順序做，一里程碑一 commit，全綠＋pyflakes 才 commit，**不 push**。
